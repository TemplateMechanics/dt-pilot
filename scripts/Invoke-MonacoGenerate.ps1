...
.EXAMPLE
    ./scripts/Invoke-MonacoGenerate.ps1 -Path . -Type deletefile -Output deletefile.yaml

.EXAMPLE
    ./scripts/Invoke-MonacoGenerate.ps1 -Type schema -Schema builtin:alerting.profile

.EXAMPLE
    ./scripts/Invoke-MonacoGenerate.ps1 -Path . -Type graph -Output graph.dot
#>
